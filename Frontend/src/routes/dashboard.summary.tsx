        ...
        <div className="mt-6 rounded-2xl glass p-6">
          ...
          <div className="mt-6 space-y-4 text-sm leading-relaxed">
            <ReactMarkdown
              components={{
                h3: ({ children }) => (
                  <h3 className="mt-6 mb-3 text-base font-bold text-foreground tracking-tight border-b border-border/40 pb-1.5 first:mt-0">
                    {children}
                  </h3>
                ),
                hr: () => <hr className="my-5 border-border/40" />,
                strong: ({ children }) => (
                  <strong className="block font-semibold text-foreground text-[14px] mt-2 mb-0.5">
                    {children}
                  </strong>
                ),
                ul: ({ children }) => (
                ...
                ol: ({ children }) => (
                  <ol className="space-y-4 pl-4 list-decimal text-muted-foreground">
                    {children}
                  </ol>
                ),
                li: ({ children }) => (
